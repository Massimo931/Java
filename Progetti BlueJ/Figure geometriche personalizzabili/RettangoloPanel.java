...
public class RettangoloPanel extends JPanel implements ActionListener
{
    JPanel risultati, layout, form, bottoni;
    JTextField txt1,txt2, txt3, txt4, txt5, txt6;
    JLabel base, perimetro, area, cordx, cordy, colore, altezza, colore1;
    JButton calcolo;
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        Rettangolo figura = new Rettangolo(b,h);
        
        txt2.setText(String.valueOf(figura.Perimetro()));
        txt3.setText(String.valueOf(figura.Area()));
        
        RettangoloDisegnabile disegno = new RettangoloDisegnabile(b,h);
    ...
    public void paintComponent(Graphics g)
    {
        ...
        g.setColor(c1);
        g.fillRect(x,y,b1,h1);
        
        g.setColor(c);
        g.fillRect(x + 5,y + 5,b1 - 10,h1 - 10);
    }
}
